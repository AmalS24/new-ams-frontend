...
function Branch(props) {
  ...
  return <div className="w-1/3 h-auto bg-white shadow-xl rounded-md">
              <div className="w-full items-center justify-between px-3 space-y-2 flex">
              ...
              <div className="w-full h-auto sapce-x-3 flex">
